...
pcall(function()
	userinfo = HttpServiceJSONDecode(readfile(discordlibinfo.txt));
end)

pfp = userinfo[pfp] or httpswww.roblox.comheadshot-thumbnailimageuserId=.. game.Players.LocalPlayer.UserId ..&width=420&height=420&format=png
...
local function SaveInfo()
	...
	userinfo[user] = user
	userinfo[tag] = tag
	writefile(discordlibinfo.txt, HttpServiceJSONEncode(userinfo));
end
...
local function MakeDraggable(topbarobject, object)
	...
	topbarobject.InputBeganConnect(
		function(input)
	...
	topbarobject.InputChangedConnect(
		function(input)
			if
	...
	UserInputService.InputChangedConnect(
		function(input)
...
function DiscordLibWindow(text)
	...
	CloseIcon.Image = httpwww.roblox.comassetid=6035047409
	...
	MinimizeIcon.Image = httpwww.roblox.comassetid=6035067836
	...
	UserCircleImage.Image = rbxassetid4031889928
	...
	CloseBtn.MouseButton1ClickConnect(
		function()
			MainFrameTweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
			wait(1)
			Discord.Parent = nil
		end
	)

	CloseBtn.MouseEnterConnect(
		function()
			CloseBtn.BackgroundColor3 = Color3.fromRGB(240, 71, 71)
		end
	)

	CloseBtn.MouseLeaveConnect(
		function()
			CloseBtn.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
		end
	)

	MinimizeBtn.MouseEnterConnect(
		function()
			MinimizeBtn.BackgroundColor3 = Color3.fromRGB(40, 43, 46)
		end
	)

	MinimizeBtn.MouseLeaveConnect(
		function()
			MinimizeBtn.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
		end
	)

	MinimizeBtn.MouseButton1ClickConnect(
		function()
	...
	SettingsOpenBtnIco.Image = httpwww.roblox.comassetid=6031280882
	...
	CloseSettingsBtnIcon.Image = httpwww.roblox.comassetid=6035047409
	CloseSettingsBtnIcon.ImageColor3 = Color3.fromRGB(222, 222, 222)

	CloseSettingsBtn.MouseButton1ClickConnect(function()
		settingsopened = false
		TopFrameHolder.Visible = true
		ServersHoldFrame.Visible = true
		SettingsHolderTweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
		TweenServiceCreate(
			Settings,
			TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			{BackgroundTransparency = 1}
		)Play()
		for i,v in next, SettingsHolderGetChildren() do
			TweenServiceCreate(
				v,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundTransparency = 1}
	...
	CloseSettingsBtn.MouseEnterConnect(function()
		CloseSettingsBtnCircle.BackgroundColor3 = Color3.fromRGB(72,76,82)
	end)

	CloseSettingsBtn.MouseLeaveConnect(function()
		CloseSettingsBtnCircle.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
	end)

	UserInputService.InputBeganConnect(
		function(io, p)
	...
	EditBtn.MouseEnterConnect(function()
		TweenServiceCreate(
			EditBtn,
	...
	EditBtn.MouseLeaveConnect(function()
		TweenServiceCreate(
			EditBtn,
			TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
	...
	UserPanelUserCircle.Image = rbxassetid4031889928
	...
	SearchIco.Image = httpwww.roblox.comassetid=6034407084
	SearchIco.ImageColor3 = Color3.fromRGB(114, 118, 125)

	UserPanelUserIcon.MouseEnterConnect(function()
		BlackFrame.Visible = true
	end)

	UserPanelUserIcon.MouseLeaveConnect(function()
		BlackFrame.Visible = false
	end)

	UserPanelUserIcon.MouseButton1ClickConnect(function()
		...
		AvatarChangeTweenSize(UDim2.new(0, 346, 0, 198), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
		TweenServiceCreate(
			AvatarChange,
			TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		ChangeBtn.MouseEnterConnect(function()
			TweenServiceCreate(
				ChangeBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		ChangeBtn.MouseLeaveConnect(function()
			TweenServiceCreate(
				ChangeBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		ChangeBtn.MouseButton1ClickConnect(function()
			pfp = tostring(AvatarTextbox.Text)
			UserImage.Image = pfp 
			UserPanelUserImage.Image = pfp
			SaveInfo()

			AvatarChangeTweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
			TweenServiceCreate(
				AvatarChange,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundTransparency = 1}
		...
		Close2Icon.Image = httpwww.roblox.comassetid=6035047409
		...
		ResetBtn.MouseButton1ClickConnect(function()
			pfp = httpswww.roblox.comheadshot-thumbnailimageuserId=.. game.Players.LocalPlayer.UserId ..&width=420&height=420&format=png
			UserImage.Image = pfp 
			UserPanelUserImage.Image = pfp
			SaveInfo()
		...
		CloseBtn1.MouseButton1ClickConnect(function()
			AvatarChangeTweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
			TweenServiceCreate(
				AvatarChange,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		CloseBtn2.MouseButton1ClickConnect(function()
			AvatarChangeTweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
			TweenServiceCreate(
				AvatarChange,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		CloseBtn2.MouseEnterConnect(function()
			TweenServiceCreate(
				Close2Icon,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		CloseBtn2.MouseLeaveConnect(function()
			TweenServiceCreate(
				Close2Icon,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		AvatarTextbox.FocusedConnect(function()
			TweenServiceCreate(
				TextBoxFrame,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(114, 137, 228)}
		...
		AvatarTextbox.FocusLostConnect(function()
			TweenServiceCreate(
				TextBoxFrame,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
	...
	SettingsOpenBtn.MouseButton1ClickConnect(function ()
		settingsopened = true
		TopFrameHolder.Visible = false
		ServersHoldFrame.Visible = false
		SettingsFrame.Visible = true
		SettingsHolderTweenSize(UDim2.new(0, 681, 0, 375), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
	...
	EditBtn.MouseButton1ClickConnect(function()
		local NotificationHolder = Instance.new(TextButton)
		NotificationHolder.Name = NotificationHolder
		NotificationHolder.Parent = SettingsHolder
		NotificationHolder.BackgroundColor3 = Color3.fromRGB(22,22,22)
		...
		UserChangeTweenSize(UDim2.new(0, 346, 0, 198), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
		TweenServiceCreate(
			UserChange,
			TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			{BackgroundTransparency = 0}
		...
		ChangeBtn.MouseButton1ClickConnect(function()
			...
			UserChangeTweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
			TweenServiceCreate(
				UserChange,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundTransparency = 1}
		...
		TagTextbox.ChangedConnect(function()
			TagTextbox.Text = TagTextbox.Textsub(1,4)	
		end)

		TagTextboxGetPropertyChangedSignal(Text)Connect(function()
			TagTextbox.Text = TagTextbox.Textgsub('%D+', '');
		end)

		UsernameTextbox.ChangedConnect(function()
			UsernameTextbox.Text = UsernameTextbox.Textsub(1,13)	
		end)

		TagTextbox.FocusedConnect(function()
			TweenServiceCreate(
				TextBoxFrame,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(114, 137, 228)}
		...
		TagTextbox.FocusLostConnect(function()
			TweenServiceCreate(
				TextBoxFrame,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(37, 40, 43)}
		...
		UsernameTextbox.FocusedConnect(function()
			TweenServiceCreate(
				TextBoxFrame,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(114, 137, 228)}
		...
		UsernameTextbox.FocusLostConnect(function()
			TweenServiceCreate(
				TextBoxFrame,
				TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(37, 40, 43)}
	...
	function DiscordLibNotification(titletext, desctext, btntext)
		...
		NotificationTweenSize(UDim2.new(0, 346, 0, 176), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
		...
		AlrightBtn.MouseButton1ClickConnect(function()
			TweenServiceCreate(
				NotificationHolderMain,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundTransparency = 1}
			)Play()
			NotificationTweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .2, true)
			TweenServiceCreate(
				Notification,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundTransparency = 1}
			...
			wait(.2)
			NotificationHolderMainDestroy()
		end)

		AlrightBtn.MouseEnterConnect(function()
			TweenServiceCreate(
				AlrightBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(103,123,196)}
		...
		AlrightBtn.MouseLeaveConnect(function()
			TweenServiceCreate(
				AlrightBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(114, 137, 228)}
	...
	local ServerHold = {}
	function ServerHoldServer(text, img)
		local fc = false
		...
		Glow.ZIndex = 0
		Glow.Image = rbxassetid4996891970
		...
		GlowChannel.ZIndex = 15
		GlowChannel.Image = rbxassetid4996891970
		...
		ServerChannelHolder.MouseEnterConnect(function()
			ServerChannelHolder.ScrollBarImageTransparency = 0
		end)

		ServerChannelHolder.MouseLeaveConnect(function()
			ServerChannelHolder.ScrollBarImageTransparency = 1
		end)

		Server.MouseEnterConnect(
			function()
		...
		Server.MouseButton1ClickConnect(
			function()
				currentservertoggled = Server.Name
				for i, v in next, ServersHolderGetChildren() do
					if v.Name == ServerFrame then
						v.Visible = false
					end
					ServerFrame.Visible = true
				end
				for i, v in next, ServersHoldGetChildren() do
		...
		local ChannelHold = {}
		function ChannelHoldChannel(text)
			...
			ChannelBtn.MouseEnterConnect(function()
			...
			ChannelBtn.MouseLeaveConnect(function()
				if currentchanneltoggled ~= ChannelBtn.Name then
					ChannelBtn.BackgroundColor3 = Color3.fromRGB(47, 49, 54)
					ChannelBtnTitle.TextColor3 = Color3.fromRGB(114, 118, 125)
				end
			...
			ChannelBtn.MouseButton1ClickConnect(function()
				for i, v in next, ChannelContentFrameGetChildren() do
					if v.Name == ChannelHolder then
						v.Visible = false
					end
					ChannelHolder.Visible = true
				end
				for i, v in next, ServerChannelHolderGetChildren() do
					if v.ClassName == TextButton then
			...
			function ChannelContentButton(text,callback)
			...
			function ChannelContentToggle(text,default,callback)
				local toggled = false
				...
				Icon.Image = httpwww.roblox.comassetid=6035047409
				...
				if default == true then
					...
					ToggleFrameCircleTweenPosition(UDim2.new(0.655, -5, 0.133000001, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
					TweenServiceCreate(
						Icon,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{ImageTransparency = 1}
					)Play()
					Icon.Image = httpwww.roblox.comassetid=6023426926
					wait(.1)
					TweenServiceCreate(
						Icon,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				...
				Toggle.MouseButton1ClickConnect(function()
					if toggled == false then
						...
						ToggleFrameCircleTweenPosition(UDim2.new(0.234999999, -5, 0.133000001, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
						TweenServiceCreate(
							Icon,
							TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{ImageTransparency = 1}
			...
			function ChannelContentSlider(text, min, max, start, callback)
				local SliderFunc = {}
				...
				Zip.MouseEnterConnect(function()
					if dragging == false then
						ValueBubble.Visible = true
					end
				end)

				Zip.MouseLeaveConnect(function()
					if dragging == false then
						ValueBubble.Visible = false
					end
				end)
				...
				GlowBubble.ZIndex = 0
				GlowBubble.Image = rbxassetid4996891970
				...
				gameGetService(UserInputService).InputChangedConnect(
				function(input)
				...
				function SliderFuncChange(tochange)
			...
			function ChannelContentSeperator()
			...
			function ChannelContentDropdown(text, list, callback)
				local DropFunc = {}
				local itemcount = 0
				local framesize = 0
				local DropTog = false
				...
				ArrowImg.Image = httpwww.roblox.comassetid=6034818372
				...
				DropdownFrameBtn.MouseButton1ClickConnect(function()
				...
				for i,v in next, list do
					...
					Item.MouseEnterConnect(function()
						ItemText.TextColor3 = Color3.fromRGB(255,255,255)
						Item.BackgroundTransparency = 0
					end)

					Item.MouseLeaveConnect(function()
						ItemText.TextColor3 = Color3.fromRGB(212, 212, 212)
						Item.BackgroundTransparency = 1
					end)

					Item.MouseButton1ClickConnect(function()
				...
				function DropFuncClear()
					for i,v in next, DropItemHolderGetChildren() do
						if v.Name == Item then
							vDestroy()
						end
					end						
			...
			function ChannelContentColorpicker(text, preset, callback)
				...
				Color.ZIndex = 10
				Color.Image = rbxassetid4155801252
				...
				ColorSelection.Image = httpwww.roblox.comassetid=4805639000
				...
				HueSelection.Image = httpwww.roblox.comassetid=4805639000
				...
				Color.InputBeganConnect(
					function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 then

							if ColorInput then
								ColorInputDisconnect()
							end

							ColorInput =
								RunService.RenderSteppedConnect(
									function()
									local ColorX =
			...
			function ChannelContentTextbox(text, placetext, disapper, defaultText, callback)
				...
				TextBox.FocusLostConnect(function(ep)
					TweenServiceCreate(
						TextboxFrameOutline,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(37, 40, 43)}
			...
			function ChannelContentLabel(text)
				...
				local label_funcs = {}
				function label_funcsSet(text)
					LabelTitle.Text = text
				end
				return label_funcs
			end

			function ChannelContentBind(text, presetbind, callback)
				...
				Keybind.MouseButton1ClickConnect(function()
					KeybindText.Text = ...
					local inputwait = gameGetService(UserInputService).InputBeganwait()
				...
				gameGetService(UserInputService).InputBeganconnect(
